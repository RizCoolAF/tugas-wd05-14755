    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt($credentials, $request->remember)) {
            ...
            if (auth()->user()->role === 'admin') {
                ...
                return redirect()->route('dokter.dashboard')->with('success', 'Welcome, Dokter!');
            } else {
                return redirect()->route('pasien.dashboard')->with('success', 'Selamat datang Pasien!');
            }
        }
    ...
    public function register(Request $request)
    {
        ...
        try {
            $validated = $request->validate([
                ...
                'password.confirmed' => 'Konfirmasi password belum valid',
