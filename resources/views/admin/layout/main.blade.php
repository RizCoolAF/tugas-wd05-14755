...
<html lang="en">
  <head>
    ...
    <title>@yield('title') | Admin HealthSys</title>
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="{{ route('landingpage') }}" class="brand-link">
          ...
          <span class="brand-text font-weight-light">HealthSys</span>
        </a>
      ...
      <footer class="main-footer bg-light text-sm border-top pt-2">
        ...
        <strong class="text-muted">
          &copy; {{ date('Y') }} <a href="#" class="text-primary font-weight-bold">HealthSys</a>.
        </strong>
        All rights reserved.
      </footer>
    </div>
